// ============================================================
//  PROFILE PAGE  (Updated — supports Edit Profile navigation)
...
const USER_ID = 2; // Aanya's ID — replace with session user ID later
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      try {
        ...
        setError("Could not load profile. Make sure your backend is running.");
      } finally {
        setLoading(false);
      }
    };
